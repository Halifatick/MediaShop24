!function () {
    ...
    var e = {
        9121: function (e, t, n) {
            ...
            function m(e, t) {
                ...
                if (t.singleton) {
                    var a = p++;
                    n = v || (v = u(t)), r = f.bind(null, n, a, !1), o = f.bind(null, n, a, !0)
    ...
    n.n = function (e) {
        ...
        var e = n(1892), t = n.n(e), r = n(9121);
        t()(r.Z, {
            insert: "head",
            singleton: !1
        }), r.Z.locals, new window.$mediashop.Swiper(".news__category-slider", {freeMode: !0, slidesPerView: "auto"});
        var o = document.querySelector(".news__articles"), a = document.createElement("div"),
            i = document.querySelector(".btn-view.active") || a;
        document.addEventListener("click", (function (e) {
            var t = e.target.closest(".btn-view");
            t && o && (i.classList.remove("active"), t.classList.add("active"), i = t, o.className = "news__articles ".concat(t.dataset.value))
        }))
    }()
}();
