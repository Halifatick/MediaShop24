!function () {
    ...
    }, e = c(1892), n = c.n(e), t = c(8018), r = {
        insert: "head",
        singleton: !1
    }, n()(t.Z, r), t.Z.locals, (o = document.querySelector(".lk__copy-btn")) && o.addEventListener("click", (function () {
        var e = o.parentElement.querySelector(".promo-code");
        window.navigator.clipboard.writeText(e.innerText), o.addEventListener("animationend", (function () {
            o.classList.remove("copied")
        }), {once: !0}), o.classList.add("copied")
    }))
}();
