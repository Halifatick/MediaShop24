!function () {
    ...
    t.n = function (e) {
        ...
        var e = t(1892), n = t.n(e), r = t(5257), o = (n()(r.Z, {
            insert: "head",
            singleton: !1
        }), r.Z.locals, new window.$mediashop.Swiper(".compare__category-slider", {
            freeMode: !0,
            slidesPerView: "auto"
        }));
        setTimeout((function () {
        ...
        var i = new window.$mediashop.Swiper(".compare-container-img", {
            slidesPerView: "auto",
        ...
        }), a = new window.$mediashop.Swiper(".compare-container-def", {slidesPerView: "auto"});
        i.controller.control = a, a.controller.control = i;
        var c = !1, s = document.querySelector(".compare-container-img"), u = document.querySelector(".header"),
            l = function () {
                var e = Math.round(s.getBoundingClientRect().top);
                if (!c && e <= u.offsetHeight) return s.classList.add("compare-container-small"), void (c = !0);
                c && e > u.offsetHeight + 50 && (s.classList.remove("compare-container-small"), c = !1)
            };
        window.addEventListener("scroll", (function () {
            document.documentElement.clientWidth >= window.$mediashop.breakpoints.m || l()
        }), {passive: !0});
        var d = window.$mediashop.breakpoints.m, f = document.documentElement.clientWidth < d;
        window.addEventListener("resize", (function () {
            if (document.documentElement.clientWidth < d && !f) return l(), void (f = !0);
            document.documentElement.clientWidth >= d && f && (f = !1)
        }))
    }()
}();
