    ...
    <main>
        ...
        <div class="main-banner-sale">
            <picture>
                ...
                <img class=content-img src="img/content/banner-sale.jpg" srcset="img/content/banner-sale@2x.jpg 2x"
            ...
            <section class="main-form">
                ...
                <form class="form form--main" method="post" autocomplete="on">
                    <label class="form__field-wrap form__field-wrap--main">
                        <input type="text" name="email" placeholder="Введите email" data-validate="email" required>
                    </label>
