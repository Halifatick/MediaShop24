!function () {
    ...
    n.n = function (e) {
        ...
        var e = n(1892), t = n.n(e), r = n(9121), o = (t()(r.Z, {
            insert: "head",
            singleton: !1
        }), r.Z.locals, new window.$mediashop.Swiper(".news__category-slider", {freeMode: !0, slidesPerView: "auto"}));
        setTimeout((function () {
            o.update()
        }));
        var i = document.querySelector(".news__articles"), a = document.createElement("div"),
            c = document.querySelector(".btn-view.active") || a;
        document.addEventListener("click", (function (e) {
            var t = e.target.closest(".btn-view");
            t && i && (c.classList.remove("active"), t.classList.add("active"), c = t, i.className = "news__articles ".concat(t.dataset.value))
        }))
    }()
}();
