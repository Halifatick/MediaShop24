    ...
    n.n = function (e) {
        ...
        document.addEventListener("click", (function (e) {
            ...
            if (e.target.closest(".fixed-buy-click") && (e.preventDefault(), document.querySelector(".product-card__buy-click").click()), t) {
                ...
                var i = t.getAttribute("href"), r = document.querySelector(i);
                r.classList.contains("active") || r.click()
        ...
        var b = !1, y = document.querySelector(".card-preview__footer"),
            g = document.querySelector(".card-preview__fixed"), S = (null == g ? void 0 : g.offsetHeight) || 96,
            x = document.querySelector(".footer"), E = function () {
                var e = Math.round(y.getBoundingClientRect().top);
                if (!b && e <= 124) return g.classList.add("fixed"), x.style.setProperty("--offset-bottom", S + "px"), void (b = !0);
                b && e > 124 && (g.classList.remove("fixed"), b = !1)
            }, _ = window.$mediashop.breakpoints.m;
        window.addEventListener("scroll", (function () {
            document.documentElement.clientWidth >= _ || E()
        }), {passive: !0});
        var L = document.documentElement.clientWidth < _;
        window.addEventListener("resize", (function () {
            if (document.documentElement.clientWidth >= v && !w ? h() : w = !1, document.documentElement.clientWidth < _ && !L) return E(), void (L = !0);
            document.documentElement.clientWidth >= _ && L && (L = !1)
        }))
    }()
}();
