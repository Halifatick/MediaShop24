!function () {
    ...
    }, e = i(1892), t = i.n(e), n = i(1058), t()(n.Z, {
        insert: "head",
        singleton: !1
    }), n.Z.locals, document.addEventListener("click", (function (e) {
        var t = e.target.closest(".accordion__items-header");
        if (t) {
            var n = document.querySelector(".vacancies__accordion");
            if (!n) return;
            if (t.classList.contains("active")) t.classList.remove("active"); else {
                var r = n.querySelector(".active");
                r && r.classList.remove("active"), t.classList.add("active")
            }
        }
    }))
}();
