!function () {
    ...
    var e, t, n, r, o, i, a, c, u = {
        1502: function (e, t, n) {
            ...
            function m(e, t) {
                ...
                if (t.singleton) {
                    var i = p++;
                    n = v || (v = u(t)), r = f.bind(null, n, i, !1), o = f.bind(null, n, i, !0)
    ...
    }, e = l(1892), t = l.n(e), n = l(1502), r = {
        insert: "head",
        singleton: !1
    }, t()(n.Z, r), n.Z.locals, o = document.createElement("div"), i = document.querySelector(".service__tab-list"), a = document.querySelector(".service__tab-content:not([hidden])") || o, c = document.querySelector('.service__tab-title[aria-selected="true"]') || o, i && i.addEventListener("click", (function (e) {
        var t = e.target.closest(".service__tab-title");
        if (t) {
            c.removeAttribute("aria-selected"), t.setAttribute("aria-selected", "true"), c = t, a.hidden = !0;
