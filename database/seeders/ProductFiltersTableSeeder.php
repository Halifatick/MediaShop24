...
class ProductFiltersTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $productFilters = [
            //Телевизоры бренд
            ['subcategory_id'=>1,'filter'=>'Sony'],
            ['subcategory_id'=>1,'filter'=>'Samsung'],
            ['subcategory_id'=>1,'filter'=>'LG'],
            ['subcategory_id'=>1,'filter'=>'Philips'],
            ['subcategory_id'=>1,'filter'=>'ProCaster'],
            ['subcategory_id'=>1,'filter'=>'Panasonic'],
            //Телевизоры по диагонали
            ['subcategory_id'=>2,'filter'=>'до 20"'],
            ['subcategory_id'=>2,'filter'=>'20"- 30"'],
            ['subcategory_id'=>2,'filter'=>'30"- 40"'],
            ['subcategory_id'=>2,'filter'=>'40"- 50"'],
            ['subcategory_id'=>2,'filter'=>'50"- 60"'],
            ['subcategory_id'=>2,'filter'=>'более 60"'],
            //Телевизоры по типу экрана
            ['subcategory_id'=>3,'filter'=>'ЖК(LED)'],
            ['subcategory_id'=>3,'filter'=>'ЖК(LCD)'],
            ['subcategory_id'=>3,'filter'=>'OLED'],
            ['subcategory_id'=>3,'filter'=>'QLED'],
            ['subcategory_id'=>3,'filter'=>'Nano Cell'],
            //Телевизоры по назначению
            ['subcategory_id'=>4,'filter'=>'Для бизнеса'],
            ['subcategory_id'=>4,'filter'=>'Для киноманов'],
            ['subcategory_id'=>4,'filter'=>'Для гостиной'],
            ['subcategory_id'=>4,'filter'=>'Для кухни'],
            ['subcategory_id'=>4,'filter'=>'Для спальни'],
            ['subcategory_id'=>4,'filter'=>'Для дачи'],
            //Проекторы бренд
